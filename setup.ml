...
(* OASIS_START *)
(* DO NOT EDIT (digest: 887c2b869acdbbed715ee5e6ecc4b58b) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "pci_typegen_gen.ml"});
               Executable
                 ({
                     cs_name = "pci_typegen";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "pci_typegen"
                        ];
                      bs_c_sources = ["pci_typegen.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                   ...
                   {exec_custom = false; exec_main_is = "pci_typegen.ml"});
               Executable
                 ({
                     cs_name = "test_pci";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\236P\029\184kV\006\226Z\194\244G~\014\236\196";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
